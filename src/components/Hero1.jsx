...
const Hero1 = () => {
    ...
    return (
        ...
        <div className='main-container w-screen h-[6905.03px] mt-[-0.47px] ml-[0.14px]'>

            <div className='header-div w-screen h-[1120.5px]'>
                <div className='header-div1 w-[853.8px] h-[198px] mt-[178.5px] ml-[42px]'>
                    <h1 className='text-[5.2rem] font-semi leading-tight'>PROPELLING THE <br />WORLD, BY DESIGN.
                    </h1>
                </div>
                <div className='w-[1328px] h-[598px] mt-[432px] ml-[56px]'></div>
            </div>


            {/* About Us section */}

            <div ref={ref} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='w-screen h-[1272px]'>
                <div  className='w-screen h-[912px] mt-[129.47px] ml-[-0.05px] mb-[230.53px]'>
                    ...
                    {/* <div onMouseEnter={handleAbouUsMouseEnter} onMouseLeave={handleAboutUsLeave} className='w-[150.75px] h-[88.5px] mt-[584.28px] ml-[1133.31px]'>
            ...
            <div className='w-screen h-[211.5px] p-t-57.75 p-r-42 p-b-57.75 p-l-42 gap-[6px] '>
                <div className='w-[1227.88px] h-[96px] gap-[257.25px] mt-[57.75px] mb-[57.75px] '>
                    <div className='w-[430px] h-[96px]  text-[86.43px] leading-[96.45px]'><h1>SERVICES</h1></div>
                    <div className='w-[540.63px] h-[83px] text-[15px] leading-[22.5px] ml-[687.25px] mb-[70.75px] mr-[170.12px] mt-[-90px]'><p className=''>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere <br /> laboriosam soluta asperiores magnam neque quo sint dolores<br />Lorem ipsum dolor sit, amet consectetur adipisicing.</p></div>
                </div>
            </div>
            ...
            >
                ...
                <div className='w-[7751px] h-[873px]'>

                    <SwiperSlide>
                        <div  className='mb-[190.5px] flex space-x-[-100px] mt-[190.5px] text-#2C2C2C ml-[56.14px]' ><h1 className='text-[220px] leading-none'>CONSULTING<br />AND STRATEGY</h1>



                        
                        
                            <div className=''><ul className='leading-loose font-grey-500'>
                    ...
                    <SwiperSlide>
                        <div className='flex space-x-[-650px] mt-[190.5px] ' > <h1 className='text-[220px] leading-none'>USER<br />EXPERIENCE</h1>
                            
                            <div className='ml-[1358px]' ><ul className=' leading-loose font-grey-500'>
                                <li>UX AUDIT</li>
                                <li>UX RESEARCH</li>
                    ...
                    <SwiperSlide>
                        <div className='flex space-x-[-520px] mt-[190.5px]'><h1 className='ml-[30px] text-[220px] leading-none'>PRODUCT<br /> DEVELOPMENT</h1>
                    ...
                    <SwiperSlide>
                        <div className='flex space-x-[-400px] mt-[190.5px]'> <h1 className='text-[220px] text-grey-500 leading-none'>DIGITAL<br />MARKETING</h1>
                            <ul className='leading-loose font-grey-500'>
                                <li>SEO</li>
                                <li>SOCIAL MEDIA</li>
                                <li>PAID SEARCH</li>
           ...
           {/* Portfolio Section */}
            ...
            <div className='w-screen h-[198.5px] p-t-57.75 p-r-42 p-b-57.75 p-l-42 gap-[6px]'>
                <div className='w-[1226.63px] h-[83px] gap-[195px]'>

                    <div className='w-[491px] h-[62px] ml-[42px]'><h1 className='text-[86.43px] '>PORTFOLIO</h1></div>
                    <div className='w-[540.63px] h-[83px] ml-[686px] mr-[171.37px] mb-[57.75px] mt-[-30px]'><p className='text-[15px] leading-[22.5px] ml-[195px]'>Lorem ipsum dolor sit amet consectetur<br /> adipisicing elit. Facere laboriosam soluta</p></div>
                </div>
            </div>
            ...
            >
                ...
                <div className='w-[6343.25px] h-[651.5px] mt-[0.25px] p-t-0 p-r-218 p-b-0 p-l-0 '>
                    <SwiperSlide className=''>
                        <div className='w-[653.23px] h-[651.5px]'>
           ...
           {/* Companies Images */}
            ...
            <div className='w-screen h-[293.25px]'>
                <div className='w-[981.62px] h-[146.67px] mt-[82.32px] ml-[223.45px]'>
            ...
            <div className='w-screen h-[1597px]'>
                <div ref={refSecond} onMouseEnter={handleSecondMouseEnter} onMouseLeave={handleSecondMouseLeave} className='w-screen h-[1246px] mt-[209.72px] mb-[141.28px]'>
                    <div className='w-[552.86px] h-[163px] mt-[305.97px] ml-[45.36px] text-[89px] leading-none '><h1 className='mt-[96.25px]'>INDUSTRIES<br />WE SERVED</h1></div>
                    <div className='w-[540.63px] h-[83px] ml-[730.79px] mt-[96.25px]'><p className='ml-[132.58px]'>Lorem ipsum dolor sit amet consectetur<br /> adipisicing elit. Facere laboriosam soluta</p></div>
                    <div onMouseEnter={handleServicesMouseEnter} onMouseLeave={handleServiceMouseLeave} className='w-[150.75px] h-[88.5px] mt-[437.44px] ml-[1133.22px] mb-[1071.06px]'><svg className='mt-[227.72px] mb-[929.78px]' width="152" height="90" viewBox="0 0 152 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div  className='w-[528px] h-[607px] mt-[-1500.28px] mb-[415.72px] ml-[45px]'><img className='mt-[364.56px]' src={glass} alt="glass" /></div>
                    
                   


                    <div className='w-screen mt-[614.88px] h-[775px] mb-[207.12px] '>
                        <div className='w-screen h-[684px] mt-[-1250.97px] ml-[50rem] mb-[298.03px] text-[21px]'>
                            <div className='w-screen h-[85.5px]'><h3>FINTECH</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>TECHNOLOGY</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>E-COMMERCE</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>SUPPLY CHAIN AND LOGISTICS</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>HEALTHCARE</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>FOOD AND BEVERAGES</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>BIOPHARMACEUTICAL</h3></div>
                            <div className='w-screen h-[85.5px]'><h3>MANUFACTURING</h3></div>
            ...
            <div className='w-screen h-[432px] '>
                <div className='w-[251px] h-[28px] mt-[43.34px] ml-[594.5px] '><h4  className='mt-[-300px] '>Wanna Know a Secret ?</h4></div>
                <div ref={refHeading} onMouseEnter={handleHeadingMouseEnter} onMouseLeave={handleHeadingMouseLeave} className='w-screen h-[309px] mt-[123px] ml-[0.1px] flex justify-center'><h1 className='text-[139.28px] leading-[155.43px]'>LETS TALK</h1></div>
            </div>


            <div className='w-screen h-[254.25px]'>
                <div className='w-[1326.97px] h-[93px] mt-[138px] ml-[56.52px] p-t-0 p-r-3 p-b-0 p-l-3 gap-[367px] mix-blend-difference '>
                    <div className='w-[237px0] h-[93px]'>
                        <div ref={footerlogoRef} className='w-[169.5px] h-[60.75px]'><img ref={footerlogoRef} className='logo-footer w-[169.5px] h-[60.75px] ' src={footerLogo} alt="footerlogo" /></div>
                        <div className='w-[237px] h-[21px] mt-[72px]'><img className='w-[237px] h-[20px] ' src={Rights} alt="rightsfooter" /></div>
                    </div>
                    <div className='w-[716.97px] h-[64.5px] gap-[90px]'><img src={footer} alt="footer" /></div>
                </div>
            </div>
