...
const Hero = () => {
    ...
    return (
        ...
        <div className='main-container w-[1440px]' >
            ...
            <div ref={ref} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='AMET second-div h-[1272px]'>
                ...
                <div className=' h-[912px] mt-[129.47px] ml-[-0.05px] mb-[230.53px]'>
                    ...
                    <img className='w-[653.25px] h-[619.5px] mt-[-100.9px]  ml-[42.09px] mb-[114.94px]' src={image} alt="image" />
