...
const Hero = () => {
    ...
    return (
        ...
        <div className='main-container ' >
            ...
            <div>
                <h1 ref={ref} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='text-8xl mt-40 mb-60 px-6 '>PROPELLING THE <br />
                    WORLD, BY DESIGN.
                </h1>
            ...
            <div className='border-t border-gray-800 py-20 flex overflow-x-auto whitespace-nowrap space-x-4 '>
