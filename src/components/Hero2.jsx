...
const Hero = () => {
    ...
    const handleServiceMouseLeave = () => {
        gsap.to(circle2Ref.current, {
            scale: 1, // Reset size
            duration: 0.4,
            stroke: "#131313" // Reset stroke color
        });

        gsap.to(rect4Ref.current, {
            x: 0, // Reset position
            duration: 0.4,
            fill: "#131313", // Reset fill color
            stagger: 0.1
        });
        gsap.to(servicesRef.current, {
            fill: "#131313",
        ...
        <div className='main-container relative' >
            ...
            <div className='h-[211.5px] gap-[6px]'>
                <div className='flex gap-[257.25px] h-[96px] ml-[4.2px] py-[57.75px] mr-[170.12px]'>
                    ...
                    <p className='font-semibold text-s ml-[12rem] w-screen'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere <br /> laboriosam soluta asperiores magnam neque quo sint dolores</p>
                </div>
            ...
            <div ref={refSecond} onMouseEnter={handleSecondMouseEnter} onMouseLeave={handleSecondMouseLeave} className='h-[1597px] mt-[-500px]'>
                {/*  */}
                <div className='h-[1246px] w-screen mt-[500.72px] mb-[141.28px]'>
                    <div className='py-[20rem] h-[163px] w-[552.86px] mt-[305.97px] ml-[45.36px] '>
                        <h1 className='text-[89px] leading-tight'>INDUSTRIES<br />WE SERVED</h1>
                        <div className='w-[540.63px] h-[83px] mt-[-200px] ml-[730.79px] mb-[1066.75px] text-[15px]'   > <p className=''>Lorem ipsum dolor fdsfdsfdsdf dfdfdfdf sit amet consectetur<br /> adipisicing elit. Facere laboriosam soluta</p></div>
                    </div>


                    <div className='services-button w-[150.75px] h-[88.5px] mt-[-140px] ml-[1100.22px]'>
                    ...
                    <div ref={refImage} onMouseEnter={handleThirdMouseEnter} onMouseLeave={handleThirdMouseLeave} className=' w-[607px] h-[775px] mt-[614.88px]'>
                        <div  ref={imgRef} className='w-[528px] mt-[-550px] ml-[45px] mr-[]'>
                            <img className='' src={glass} alt="glass" /></div>


                        <div  className='ml-[700px] w-screen text-[21px] mt-[-540.97px] h-[684px] mb-[298.03px]' onMouseEnter={handleServiceListMouseEnter} onMouseLeave={handleServiceListMouseLeave}   >
                            <ul onMouseLeave={handleMouseServiceListLeave} onMouseEnter={handleMouseServiceListEnter} className=''>

                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref} >FINTECH</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>TECHNOLOGY</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref} >E-COMMERCE</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>SUPPLY CHAIN AND LOGISTICS</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>SUPPLY CHAIN AND LOGISTICS</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>FOOD AND BEVERAGES</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>BIOPHARMACEUTICAL</li></div>
                                <div ref={divRef}  className='h-[85.5px]'><li ref={text1Ref}>MANUFACTURING</li></div>
                            </ul>
                        </div>
                        {/* <div ref={textRef}>Hover over me</div> */}

                        {/* <div className="additional-text" style={{ display: 'none', marginTop: '10px' }}>
                            Additional text
                        </div> */}
